...
#define SIG_MAGIC 0x58
#define AKE_MAGIC 0x59
#define CHALLENGE_MAGIC 0x5A
#define CRYPTO_MAGIC 0x5B
 ...
 */
uint32_t receive_board_message(MESSAGE_PACKET *message, uint16_t size);
 ...
 * @param size the buffer size allocated to the message
 * @return uint32_t the number of bytes received
 */
